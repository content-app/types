...
export default function createSpaceApi(makeRequest) {
  const wrapSpace = entities.space.wrapSpace;
  const _entities$environment = entities.environment,
  ...
  const _entities$spaceMember = entities.spaceMember,
  ...
  const _entities$spaceMember2 = entities.spaceMembership,
  ...
  const wrapTeamCollection = entities.team.wrapTeamCollection;
  const _entities$apiKey = entities.apiKey,
    wrapApiKey = _entities$apiKey.wrapApiKey,
    wrapApiKeyCollection = _entities$apiKey.wrapApiKeyCollection;
  const _entities$environment2 = entities.environmentAlias,
  ...
  const _entities$previewApiK = entities.previewApiKey,
  ...
  const _entities$scheduledAc = entities.scheduledAction,
