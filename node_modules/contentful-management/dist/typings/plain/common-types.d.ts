...
import { CreateCommentParams, CreateCommentProps, DeleteCommentParams, CommentProps, UpdateCommentParams, UpdateCommentProps, GetManyCommentsParams, RichTextBodyFormat, RichCommentProps, RichCommentBodyPayload, PlainTextBodyFormat } from '../entities/comment';
...
export type PlainClientAPI = {
    ...
    comment: {
        ...
        getMany(params: OptionalDefaults<GetManyCommentsParams & QueryParams & RichTextBodyFormat>): Promise<CollectionProp<RichCommentProps>>;
        ...
        create(params: OptionalDefaults<CreateCommentParams>, rawData: RichCommentBodyPayload, headers?: AxiosRequestHeaders): Promise<RichCommentProps>;
        ...
        update(params: OptionalDefaults<UpdateCommentParams>, rawData: Omit<UpdateCommentProps, 'body'> & RichCommentBodyPayload, headers?: AxiosRequestHeaders): Promise<RichCommentProps>;
