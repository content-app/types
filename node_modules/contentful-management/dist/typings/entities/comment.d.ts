...
export type RichCommentBodyPayload = {
...
export interface RichTextComment extends Omit<CommentProps, 'body'>, RichCommentProps, DefaultElements<CommentProps>, CommentApi {
}
/**
 * @private
 */
 ...
 * @private
 */
export declare function wrapComment(makeRequest: MakeRequest, data: CommentProps | RichCommentProps): Comment | RichTextComment;
/**
 * @private
 */
export declare const wrapCommentCollection: (makeRequest: MakeRequest, data: import("../common-types").CollectionProp<CommentProps | RichCommentProps>) => import("../common-types").Collection<Comment | RichTextComment, CommentProps | RichCommentProps>;
export {};
